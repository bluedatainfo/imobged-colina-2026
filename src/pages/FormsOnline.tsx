...
const COLUMN_MAPPINGS: Record<string, string> = {
  ...
  nome1: 'full_name',
  name: 'full_name',
  'razão social': 'full_name',
  'razao social': 'full_name',
  'nome da empresa': 'full_name',
  'nome empresarial': 'full_name',
  'nome fantasia': 'full_name',
  'nome do fiador': 'full_name',
  'nome completo do fiador': 'full_name',
  cpf: 'cpf',
  cnpj: 'cnpj',
  email: 'email',
  'e-mail': 'email',
