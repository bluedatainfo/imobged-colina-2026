                  ...
                  <CardContent className="p-4 pt-0 space-y-4">
                    ...
                    {t.photo && (
                      <div className="w-full h-32 rounded-md overflow-hidden bg-muted relative">
                        <img src={t.photo} alt="Evidência" className="w-full h-full object-cover" />
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Gerencie alertas de reparos gerados automaticamente pelas vistorias de campo e analise os
          indicadores.
        </p>
      </div>
      ...
      {canViewAnalytics ? (
        <Tabs defaultValue="tickets" className="space-y-6">
          <TabsList>
            <TabsTrigger value="tickets">Gestão de Chamados</TabsTrigger>
            <TabsTrigger value="analytics">BI & Analytics</TabsTrigger>
          </TabsList>
