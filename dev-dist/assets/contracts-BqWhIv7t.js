const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/m365-CNmMUpKg.js","assets/react-CaAsmmmw.js","assets/client-SeHzFSrX.js","assets/use-toast-DzvQdsOw.js","assets/main-CHn1Mbne.js","assets/preload-helper-t9NyTnoX.js"])))=>i.map(i=>d[i]);
...
var contractsStore = {
	...
	updateStatus: (id, status) => {
		...
		if (status === "Ativo") {
			...
			__vitePreload(async () => {
				const { m365Service } = await import("./m365-CNmMUpKg.js");
				return { m365Service };
...
//# sourceMappingURL=contracts-BqWhIv7t.js.map