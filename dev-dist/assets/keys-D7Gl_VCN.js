const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/m365-BDXu_7_M.js","assets/react-CaAsmmmw.js","assets/client-C4nUQiBY.js","assets/tslib.es6-aWCavSYD.js","assets/use-toast-DzvQdsOw.js","assets/m365-C6nMyI-x.js","assets/main-7B_Nvovk.js","assets/preload-helper-t9NyTnoX.js"])))=>i.map(i=>d[i]);
...
var contractsStore = {
	...
	updateStatus: (id, status) => {
		...
		if (status === "Ativo") {
			...
			__vitePreload(async () => {
				const { m365Service } = await import("./m365-BDXu_7_M.js");
				return { m365Service };
...
//# sourceMappingURL=keys-D7Gl_VCN.js.map