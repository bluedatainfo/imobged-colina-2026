const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/m365-BvJ59W1A.js","assets/react-CaAsmmmw.js","assets/client-CRWdr5I6.js","assets/use-toast-DzvQdsOw.js","assets/main-fLnrbiCL.js","assets/preload-helper-t9NyTnoX.js"])))=>i.map(i=>d[i]);
...
var contractsStore = {
	...
	updateStatus: (id, status) => {
		...
		if (status === "Ativo") {
			...
			__vitePreload(async () => {
				const { m365Service } = await import("./m365-BvJ59W1A.js");
				return { m365Service };
...
//# sourceMappingURL=contracts-1s4pG3AA.js.map