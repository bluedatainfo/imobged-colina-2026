const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/m365-BkNnuvK7.js","assets/react-CaAsmmmw.js","assets/client-SeHzFSrX.js","assets/use-toast-DzvQdsOw.js","assets/main-UNDc7v4v.js","assets/preload-helper-t9NyTnoX.js"])))=>i.map(i=>d[i]);
...
var contractsStore = {
	...
	updateStatus: (id, status) => {
		...
		if (status === "Ativo") {
			...
			__vitePreload(async () => {
				const { m365Service } = await import("./m365-BkNnuvK7.js");
				return { m365Service };
			}, __vite__mapDeps([0,1,2,3,4,5])).then(({ m365Service }) => {
...
//# sourceMappingURL=contracts-C5Aeh034.js.map