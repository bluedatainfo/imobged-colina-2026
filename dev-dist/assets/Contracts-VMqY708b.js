...
import { t as GedUpload } from "./GedUpload-D0nCSg0f.js";
...
import { r as FilePen, t as DocumentViewer } from "./DocumentViewer-BOYaz0UI.js";
...
import { i as contractsStore, n as keysStore, o as useContractsStore } from "./keys-BxY60ceF.js";
import { n as useEntitiesStore } from "./entities-pTkigeh5.js";
import { B as Users, F as TooltipTrigger, H as User, J as Plus, N as Tooltip, P as TooltipContent, S as useTemplatesStore, X as LoaderCircle, Y as PenTool, a as DropdownMenuLabel, at as FilePenLine, et as House, g as useAuth, i as DropdownMenuItem, it as FilePlus, j as Input, n as DropdownMenu, o as DropdownMenuSeparator, r as DropdownMenuContent, rt as FileText, s as DropdownMenuTrigger, t as Badge, y as useDocumentsStore } from "./index-CRMZketn.js";
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: "Este contrato e o imóvel vinculado serão encaminhados automaticamente ao Hub de Validação para aprovação da gerência, e o status mudará para \"Em Análise\"."
								})]
							})]
						})
					]
...
//#endregion
//#region src/components/ReviewResolutionDialog.tsx
function ReviewResolutionDialog({ propertyId, onClose }) {
	const { documents } = useDocumentsStore();
	const { contracts } = useContractsStore();
	const { properties } = useMainStore();
	const [viewItem, setViewItem] = (0, import_react.useState)(null);
	properties.find((p) => p.id === propertyId);
	const pendingDocs = (0, import_react.useMemo)(() => documents.filter((d) => d.propertyId === propertyId && d.reviewNotes), [documents, propertyId]);
	const pendingContracts = (0, import_react.useMemo)(() => contracts.filter((c) => c.propertyId === propertyId && c.reviewNotes && c.status !== "Rescindido"), [contracts, propertyId]);
	...
	const handleResubmit = async () => {
		...
		try {
			const { data: propData } = await supabase.from("properties").select("tenant_id, guarantor_id").eq("id", propertyId).maybeSingle();
			if (propData?.tenant_id) await candidatesService.updateStatus(propData.tenant_id, "Em Análise da Gerência");
			if (propData?.guarantor_id) await candidatesService.updateStatus(propData.guarantor_id, "Em Análise da Gerência");
		} catch (e) {
			console.error("Error updating candidate status", e);
		}
		contracts.filter((c) => c.propertyId === propertyId && (c.status === "Rascunho" || c.status === "Em Análise")).forEach((c) => contractsStore.updateStatus(c.id, "Em Análise"));
		mainStore.addAuditLog({
			propertyId,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Dialog, {
		"data-uid": "src/components/ReviewResolutionDialog.tsx:93:5",
		"data-prohibitions": "[editContent]",
		open: !!propertyId,
		onOpenChange: (val) => !val && onClose(),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
			"data-uid": "src/components/ReviewResolutionDialog.tsx:94:7",
			"data-prohibitions": "[editContent]",
			className: "sm:max-w-[600px]",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, {
					"data-uid": "src/components/ReviewResolutionDialog.tsx:95:9",
					"data-prohibitions": "[]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogTitle, {
						"data-uid": "src/components/ReviewResolutionDialog.tsx:96:11",
						"data-prohibitions": "[]",
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldAlert, {
							"data-uid": "src/components/ReviewResolutionDialog.tsx:97:13",
							"data-prohibitions": "[editContent]",
							className: "w-5 h-5 text-amber-500"
						}), " Resolução de Pendências"]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription, {
						"data-uid": "src/components/ReviewResolutionDialog.tsx:99:11",
						"data-prohibitions": "[]",
						children: "Revise as anotações feitas pela gerência, realize as correções necessárias e marque como resolvido para liberar o reenvio."
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					"data-uid": "src/components/ReviewResolutionDialog.tsx:105:9",
					"data-prohibitions": "[editContent]",
					className: "py-4 space-y-4 max-h-[60vh] overflow-y-auto pr-2",
					children: totalPending === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/ReviewResolutionDialog.tsx:107:13",
						"data-prohibitions": "[]",
						className: "flex flex-col items-center justify-center p-8 text-center bg-emerald-50 rounded-lg border border-emerald-100",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, {
								"data-uid": "src/components/ReviewResolutionDialog.tsx:108:15",
								"data-prohibitions": "[editContent]",
								className: "w-10 h-10 text-emerald-500 mb-2"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								"data-uid": "src/components/ReviewResolutionDialog.tsx:109:15",
								"data-prohibitions": "[]",
								className: "font-medium text-emerald-900",
								children: "Todas as pendências foram resolvidas!"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								"data-uid": "src/components/ReviewResolutionDialog.tsx:110:15",
								"data-prohibitions": "[]",
								className: "text-sm text-emerald-700 mt-1",
								children: "O dossiê está pronto para ser reenviado para análise da gerência."
							})
						]
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [pendingContracts.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/ReviewResolutionDialog.tsx:117:17",
						"data-prohibitions": "[editContent]",
						className: "p-4 border rounded-lg bg-amber-50/50 border-amber-200 space-y-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-uid": "src/components/ReviewResolutionDialog.tsx:121:19",
							"data-prohibitions": "[editContent]",
							className: "flex flex-col sm:flex-row sm:items-center justify-between gap-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								"data-uid": "src/components/ReviewResolutionDialog.tsx:122:21",
								"data-prohibitions": "[editContent]",
								className: "flex items-center gap-2 font-medium text-amber-900",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, {
										"data-uid": "src/components/ReviewResolutionDialog.tsx:123:23",
										"data-prohibitions": "[editContent]",
										className: "w-4 h-4 text-amber-600 shrink-0"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										"data-uid": "src/components/ReviewResolutionDialog.tsx:124:23",
										"data-prohibitions": "[editContent]",
										className: "truncate max-w-[200px]",
										children: c.documentName
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
										"data-uid": "src/components/ReviewResolutionDialog.tsx:125:23",
										"data-prohibitions": "[]",
										variant: "outline",
										className: "bg-white ml-2 text-xs shrink-0",
										children: "Contrato"
									})
								]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								"data-uid": "src/components/ReviewResolutionDialog.tsx:129:21",
								"data-prohibitions": "[]",
								variant: "ghost",
								size: "sm",
								onClick: () => setViewItem({
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, {
									"data-uid": "src/components/ReviewResolutionDialog.tsx:135:23",
									"data-prohibitions": "[editContent]",
									className: "w-4 h-4 mr-2"
								}), " Visualizar / Corrigir"]
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-uid": "src/components/ReviewResolutionDialog.tsx:138:19",
							"data-prohibitions": "[editContent]",
							className: "text-sm text-amber-800 bg-white p-2 rounded border border-amber-100",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
									"data-uid": "src/components/ReviewResolutionDialog.tsx:139:21",
									"data-prohibitions": "[]",
									children: "Nota da Gerência:"
								}),
								" ",
								c.reviewNotes
							]
						})]
					}, c.id)), pendingDocs.map((d) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/ReviewResolutionDialog.tsx:144:17",
						"data-prohibitions": "[editContent]",
						className: "p-4 border rounded-lg bg-amber-50/50 border-amber-200 space-y-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-uid": "src/components/ReviewResolutionDialog.tsx:148:19",
							"data-prohibitions": "[editContent]",
							className: "flex flex-col sm:flex-row sm:items-center justify-between gap-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								"data-uid": "src/components/ReviewResolutionDialog.tsx:149:21",
								"data-prohibitions": "[editContent]",
								className: "flex items-center gap-2 font-medium text-amber-900",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, {
										"data-uid": "src/components/ReviewResolutionDialog.tsx:150:23",
										"data-prohibitions": "[editContent]",
										className: "w-4 h-4 text-amber-600 shrink-0"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										"data-uid": "src/components/ReviewResolutionDialog.tsx:151:23",
										"data-prohibitions": "[editContent]",
										className: "truncate max-w-[200px]",
										children: d.name
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Badge, {
										"data-uid": "src/components/ReviewResolutionDialog.tsx:152:23",
										"data-prohibitions": "[editContent]",
										variant: "outline",
										className: "bg-white ml-2 text-xs shrink-0",
										children: [
								...
								"data-uid": "src/components/ReviewResolutionDialog.tsx:156:21",
								"data-prohibitions": "[]",
								variant: "ghost",
								size: "sm",
								onClick: () => setViewItem({
								...
								className: "shrink-0 justify-start",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, {
									"data-uid": "src/components/ReviewResolutionDialog.tsx:162:23",
									"data-prohibitions": "[editContent]",
									className: "w-4 h-4 mr-2"
								}), " Visualizar / Corrigir"]
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-uid": "src/components/ReviewResolutionDialog.tsx:165:19",
							"data-prohibitions": "[editContent]",
							className: "text-sm text-amber-800 bg-white p-2 rounded border border-amber-100",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
									"data-uid": "src/components/ReviewResolutionDialog.tsx:166:21",
									"data-prohibitions": "[]",
									children: "Nota da Gerência:"
								}),
								" ",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogFooter, {
					"data-uid": "src/components/ReviewResolutionDialog.tsx:174:9",
					"data-prohibitions": "[]",
					className: "flex-col sm:flex-row gap-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						"data-uid": "src/components/ReviewResolutionDialog.tsx:175:11",
						"data-prohibitions": "[]",
						variant: "outline",
						onClick: onClose,
						className: "w-full sm:w-auto",
						...
						"data-uid": "src/components/ReviewResolutionDialog.tsx:178:11",
						"data-prohibitions": "[]",
						onClick: handleResubmit,
						disabled: totalPending > 0,
						className: "w-full sm:w-auto bg-emerald-600 hover:bg-emerald-700 text-white",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Send, {
							"data-uid": "src/components/ReviewResolutionDialog.tsx:183:13",
							"data-prohibitions": "[editContent]",
							className: "w-4 h-4 mr-2"
			...
			"data-uid": "src/components/ReviewResolutionDialog.tsx:187:7",
			"data-prohibitions": "[editContent]",
			open: !!viewItem,
...
function Contracts() {
	...
	const [resolutionPropertyId, setResolutionPropertyId] = (0, import_react.useState)(null);
	const handleStatusChange = (contract, newStatus) => {
		...
		if (newStatus === "Em Análise") mainStore.updatePropertyStatus(contract.propertyId, "Análise Gerencial");
	};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		"data-uid": "src/pages/Contracts.tsx:153:5",
		"data-prohibitions": "[editContent]",
		className: "space-y-6",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/pages/Contracts.tsx:154:7",
				"data-prohibitions": "[]",
				className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					"data-uid": "src/pages/Contracts.tsx:155:9",
					"data-prohibitions": "[]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						"data-uid": "src/pages/Contracts.tsx:156:11",
						"data-prohibitions": "[]",
					...
					"data-uid": "src/pages/Contracts.tsx:161:9",
					"data-prohibitions": "[]",
					onClick: () => setWizardOpen(true),
					className: "shrink-0 gap-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, {
						"data-uid": "src/pages/Contracts.tsx:162:11",
						"data-prohibitions": "[editContent]",
						className: "w-4 h-4"
					}), " Novo Contrato"]
				})]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				"data-uid": "src/pages/Contracts.tsx:166:7",
				"data-prohibitions": "[editContent]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
					"data-uid": "src/pages/Contracts.tsx:167:9",
					"data-prohibitions": "[]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardTitle, {
						"data-uid": "src/pages/Contracts.tsx:168:11",
						"data-prohibitions": "[]",
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, {
							"data-uid": "src/pages/Contracts.tsx:169:13",
							"data-prohibitions": "[editContent]",
							className: "w-5 h-5 text-primary"
						}), " Acervo de Contratos em Andamento"]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardDescription, {
						"data-uid": "src/pages/Contracts.tsx:171:11",
						"data-prohibitions": "[]",
						children: "Painel integrado à lista de Controle de Processos do SharePoint."
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
					"data-uid": "src/pages/Contracts.tsx:175:9",
					"data-prohibitions": "[editContent]",
					className: "p-0",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Table, {
						"data-uid": "src/pages/Contracts.tsx:176:11",
						"data-prohibitions": "[editContent]",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHeader, {
							"data-uid": "src/pages/Contracts.tsx:177:13",
							"data-prohibitions": "[]",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
								"data-uid": "src/pages/Contracts.tsx:178:15",
								"data-prohibitions": "[]",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
										"data-uid": "src/pages/Contracts.tsx:179:17",
										"data-prohibitions": "[]",
										children: "ID"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
										"data-uid": "src/pages/Contracts.tsx:180:17",
										"data-prohibitions": "[]",
										children: "Documento / Template"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
										"data-uid": "src/pages/Contracts.tsx:181:17",
										"data-prohibitions": "[]",
										children: "Inquilino"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
										"data-uid": "src/pages/Contracts.tsx:182:17",
										"data-prohibitions": "[]",
										children: "Status"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
										"data-uid": "src/pages/Contracts.tsx:183:17",
										"data-prohibitions": "[]",
										children: "Assinatura"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
										"data-uid": "src/pages/Contracts.tsx:184:17",
										"data-prohibitions": "[]",
							...
							"data-uid": "src/pages/Contracts.tsx:187:13",
							"data-prohibitions": "[editContent]",
							children: contracts.map((contract) => {
								...
								const propertyDocs = documents.filter((d) => d.propertyId === contract.propertyId && d.reviewNotes);
								const hasNotes = !!contract.reviewNotes || propertyDocs.length > 0;
								const isRejected = (contract.status === "Rascunho" || contract.status === "Em Análise") && hasNotes;
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
									"data-uid": "src/pages/Contracts.tsx:202:19",
									"data-prohibitions": "[editContent]",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
											"data-uid": "src/pages/Contracts.tsx:203:21",
											"data-prohibitions": "[editContent]",
											className: "font-mono text-xs",
											children: contract.id
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableCell, {
											"data-uid": "src/pages/Contracts.tsx:204:21",
											"data-prohibitions": "[editContent]",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												"data-uid": "src/pages/Contracts.tsx:205:23",
												"data-prohibitions": "[editContent]",
												className: "font-medium text-sm flex items-center gap-2",
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, {
														"data-uid": "src/pages/Contracts.tsx:206:25",
														"data-prohibitions": "[editContent]",
													...
													contract.isCritical && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
														"data-uid": "src/pages/Contracts.tsx:208:27",
														"data-prohibitions": "[]",
														variant: "destructive",
														className: "ml-2 py-0 h-5",
														children: "Crítico"
													}),
													contract.reviewNotes && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip, {
														"data-uid": "src/pages/Contracts.tsx:213:27",
														"data-prohibitions": "[editContent]",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipTrigger, {
															"data-uid": "src/pages/Contracts.tsx:214:29",
															"data-prohibitions": "[]",
															asChild: true,
															children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageSquareWarning, {
																"data-uid": "src/pages/Contracts.tsx:215:31",
																"data-prohibitions": "[editContent]",
																className: "w-4 h-4 text-amber-500 cursor-help"
															})
														}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TooltipContent, {
															"data-uid": "src/pages/Contracts.tsx:217:29",
															"data-prohibitions": "[editContent]",
															className: "max-w-xs p-3",
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																"data-uid": "src/pages/Contracts.tsx:218:31",
																"data-prohibitions": "[]",
																className: "font-semibold text-xs mb-1",
																children: "Apontamento da Gerência:"
															}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																"data-uid": "src/pages/Contracts.tsx:219:31",
																"data-prohibitions": "[editContent]",
																className: "text-xs",
																children: contract.reviewNotes
															})]
														})]
													})
												]
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
											"data-uid": "src/pages/Contracts.tsx:228:21",
											"data-prohibitions": "[editContent]",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableCell, {
											"data-uid": "src/pages/Contracts.tsx:244:21",
											"data-prohibitions": "[editContent]",
											children: [
												contract.docusignStatus === "Signed" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
													"data-uid": "src/pages/Contracts.tsx:246:25",
													"data-prohibitions": "[]",
													variant: "outline",
												...
												contract.docusignStatus === "Sent" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
													"data-uid": "src/pages/Contracts.tsx:254:25",
													"data-prohibitions": "[]",
													variant: "outline",
												...
												!contract.docusignStatus && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													"data-uid": "src/pages/Contracts.tsx:262:25",
													"data-prohibitions": "[]",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
											"data-uid": "src/pages/Contracts.tsx:265:21",
											"data-prohibitions": "[editContent]",
											className: "text-right",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, {
												"data-uid": "src/pages/Contracts.tsx:266:23",
												"data-prohibitions": "[editContent]",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuTrigger, {
													"data-uid": "src/pages/Contracts.tsx:267:25",
													"data-prohibitions": "[]",
													asChild: true,
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
														"data-uid": "src/pages/Contracts.tsx:268:27",
														"data-prohibitions": "[]",
														variant: "ghost",
														size: "icon",
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EllipsisVertical, {
															"data-uid": "src/pages/Contracts.tsx:269:29",
															"data-prohibitions": "[editContent]",
															className: "w-4 h-4"
														})
													})
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenuContent, {
													"data-uid": "src/pages/Contracts.tsx:272:25",
													"data-prohibitions": "[editContent]",
													align: "end",
													className: "w-64",
													children: [
														/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuLabel, {
															"data-uid": "src/pages/Contracts.tsx:273:27",
															"data-prohibitions": "[]",
															children: "Ações do Documento"
														}),
														isRejected && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenuItem, {
															"data-uid": "src/pages/Contracts.tsx:276:29",
															"data-prohibitions": "[]",
															onClick: () => setResolutionPropertyId(contract.propertyId),
															className: "text-amber-600 font-medium",
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldAlert, {
																"data-uid": "src/pages/Contracts.tsx:280:31",
																"data-prohibitions": "[editContent]",
																className: "w-4 h-4 mr-2"
															}), " Resolver Pendências"]
														}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ContractWizard, {
				"data-uid": "src/pages/Contracts.tsx:355:7",
				"data-prohibitions": "[editContent]",
				open: wizardOpen,
				onClose: () => setWizardOpen(false)
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DocumentViewer, {
				"data-uid": "src/pages/Contracts.tsx:356:7",
				"data-prohibitions": "[editContent]",
				open: !!viewItem,
				onClose: () => setViewItem(null),
				viewItem
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DocuSignDialog, {
				"data-uid": "src/pages/Contracts.tsx:357:7",
				"data-prohibitions": "[editContent]",
				contract: docusignContract,
				onClose: () => setDocusignContract(null)
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReviewResolutionDialog, {
				"data-uid": "src/pages/Contracts.tsx:358:7",
				"data-prohibitions": "[editContent]",
				propertyId: resolutionPropertyId,
				onClose: () => setResolutionPropertyId(null)
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
				"data-uid": "src/pages/Contracts.tsx:363:7",
				"data-prohibitions": "[editContent]",
				open: !!uploadContract,
				onOpenChange: (val) => !val && setUploadContract(null),
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
					"data-uid": "src/pages/Contracts.tsx:364:9",
					"data-prohibitions": "[editContent]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, {
						"data-uid": "src/pages/Contracts.tsx:365:11",
						"data-prohibitions": "[]",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, {
							"data-uid": "src/pages/Contracts.tsx:366:13",
							"data-prohibitions": "[]",
							children: "Upload de Documento Estruturado"
						})
					}), uploadContract && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						"data-uid": "src/pages/Contracts.tsx:369:13",
						"data-prohibitions": "[]",
						className: "py-4",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GedUpload, {
							"data-uid": "src/pages/Contracts.tsx:370:15",
							"data-prohibitions": "[editContent]",
...
//# sourceMappingURL=Contracts-VMqY708b.js.map