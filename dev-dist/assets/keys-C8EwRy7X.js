const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/m365-z-hCvsFc.js","assets/react-CaAsmmmw.js","assets/client-CRWdr5I6.js","assets/use-toast-DzvQdsOw.js","assets/m365-CnuquAKB.js","assets/main-BRbiWPLX.js","assets/preload-helper-t9NyTnoX.js"])))=>i.map(i=>d[i]);
...
var contractsStore = {
	...
	updateStatus: (id, status) => {
		...
		if (status === "Ativo") {
			...
			__vitePreload(async () => {
				const { m365Service } = await import("./m365-z-hCvsFc.js");
				return { m365Service };
...
//# sourceMappingURL=keys-C8EwRy7X.js.map