const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/m365-CMhb_DZX.js","assets/react-CaAsmmmw.js","assets/client-CX_7U15l.js","assets/use-toast-DzvQdsOw.js","assets/main-B7dr_xNS.js","assets/preload-helper-t9NyTnoX.js"])))=>i.map(i=>d[i]);
...
var contractsStore = {
	...
	updateStatus: (id, status) => {
		...
		if (status === "Ativo") {
			...
			__vitePreload(async () => {
				const { m365Service } = await import("./m365-CMhb_DZX.js");
				return { m365Service };
...
//# sourceMappingURL=contracts-DMcPMPzZ.js.map