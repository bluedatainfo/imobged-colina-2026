const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/m365-B1WwncVb.js","assets/react-CaAsmmmw.js","assets/client-C4nUQiBY.js","assets/tslib.es6-aWCavSYD.js","assets/use-toast-DzvQdsOw.js","assets/m365-CDhLywiC.js","assets/main-DTgwj9_d.js","assets/preload-helper-t9NyTnoX.js"])))=>i.map(i=>d[i]);
...
var contractsStore = {
	...
	updateStatus: (id, status) => {
		...
		if (status === "Ativo") {
			...
			__vitePreload(async () => {
				const { m365Service } = await import("./m365-B1WwncVb.js");
				return { m365Service };
...
//# sourceMappingURL=keys-1GLCVQ6v.js.map