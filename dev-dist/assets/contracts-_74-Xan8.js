const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/m365-1-dDqU09.js","assets/react-CaAsmmmw.js","assets/client-CRWdr5I6.js","assets/use-toast-DzvQdsOw.js","assets/m365-BRTXyLVp.js","assets/main-_gP0LOX9.js","assets/preload-helper-t9NyTnoX.js"])))=>i.map(i=>d[i]);
...
var contractsStore = {
	...
	updateStatus: (id, status) => {
		...
		if (status === "Ativo") {
			...
			__vitePreload(async () => {
				const { m365Service } = await import("./m365-1-dDqU09.js");
				return { m365Service };
			}, __vite__mapDeps([0,1,2,3,4,5,6])).then(({ m365Service }) => {
...
//# sourceMappingURL=contracts-_74-Xan8.js.map