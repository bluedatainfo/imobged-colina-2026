...
import { i as useMainStore, n as isSlaBreached } from "./main-PEgqdb3P.js";
import "./users-DQmtGtfO.js";
import { o as useContractsStore } from "./keys-D4Sm9wuc.js";
import { n as useEntitiesStore } from "./entities-pTkigeh5.js";
import { H as User, Z as List, at as FilePenLine, g as useAuth, gt as useNavigate, h as checkAccess, j as Input, mt as Link, q as Search, rt as FileText, t as Badge, ut as Building } from "./index-CWbte8-3.js";
...
import { a as BarChart, c as CartesianGrid, d as Cell, i as PieChart, l as Bar, n as ChartTooltip, o as YAxis, r as ChartTooltipContent, s as XAxis, t as ChartContainer, u as Pie } from "./chart-Df0kuJLs.js";
...
function DashboardChart() {
	...
	const neighborhoodData = Object.entries(store.properties.reduce((acc, p) => {
		let nb = p.details?.neighborhood || "Outros";
		if (nb === "Outros" && p.address) {
			const parts = p.address.split(",");
			if (parts.length >= 3) nb = parts[parts.length - 2].trim();
		}
		if (!nb) nb = "Outros";
		acc[nb] = (acc[nb] || 0) + 1;
		return acc;
	...
	if (neighborhoodData.length === 0) neighborhoodData.push({
		name: "Nenhum",
		value: 0
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		"data-uid": "src/components/DashboardChart.tsx:49:5",
		"data-prohibitions": "[editContent]",
		className: "flex flex-col gap-4 h-full",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
			"data-uid": "src/components/DashboardChart.tsx:50:7",
			"data-prohibitions": "[editContent]",
			className: "flex flex-col",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
				"data-uid": "src/components/DashboardChart.tsx:51:9",
				"data-prohibitions": "[]",
				className: "items-center pb-0",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, {
					"data-uid": "src/components/DashboardChart.tsx:52:11",
					"data-prohibitions": "[]",
					children: "Distribuição de Contratos"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardDescription, {
					"data-uid": "src/components/DashboardChart.tsx:53:11",
					"data-prohibitions": "[]",
					children: "Volume de contratos no SharePoint"
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
				"data-uid": "src/components/DashboardChart.tsx:55:9",
				"data-prohibitions": "[editContent]",
				className: "pb-0",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartContainer, {
					"data-uid": "src/components/DashboardChart.tsx:56:11",
					"data-prohibitions": "[editContent]",
					config: chartConfig,
					className: "mx-auto aspect-square max-h-[220px]",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PieChart, {
						"data-uid": "src/components/DashboardChart.tsx:57:13",
						"data-prohibitions": "[editContent]",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartTooltip, {
							"data-uid": "src/components/DashboardChart.tsx:58:15",
							"data-prohibitions": "[editContent]",
							cursor: false,
							content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartTooltipContent, {
								"data-uid": "src/components/DashboardChart.tsx:58:53",
								"data-prohibitions": "[editContent]",
								hideLabel: true
							})
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pie, {
							"data-uid": "src/components/DashboardChart.tsx:59:15",
							"data-prohibitions": "[editContent]",
							data: chartData,
							dataKey: "value",
							nameKey: "name",
							...
							children: chartData.map((entry, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Cell, {
								"data-uid": "src/components/DashboardChart.tsx:69:19",
								"data-prohibitions": "[editContent]",
								fill: entry.fill
							}, `cell-${index}`))
						})]
					...
					"data-uid": "src/components/DashboardChart.tsx:74:11",
					"data-prohibitions": "[editContent]",
					className: "grid grid-cols-2 gap-2 mt-2 text-xs text-center mb-4",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/DashboardChart.tsx:75:13",
						"data-prohibitions": "[editContent]",
						className: "bg-emerald-50 text-emerald-700 p-1.5 rounded-md font-medium border border-emerald-100",
						children: [chartData[0].value, " Ativos"]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/DashboardChart.tsx:78:13",
						"data-prohibitions": "[editContent]",
						className: "bg-blue-50 text-blue-700 p-1.5 rounded-md font-medium border border-blue-100",
						children: [chartData[1].value, " Workflow"]
					})]
				})]
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
			"data-uid": "src/components/DashboardChart.tsx:85:7",
			"data-prohibitions": "[]",
			className: "flex flex-col flex-1",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
				"data-uid": "src/components/DashboardChart.tsx:86:9",
				"data-prohibitions": "[]",
				className: "pb-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, {
					"data-uid": "src/components/DashboardChart.tsx:87:11",
					"data-prohibitions": "[]",
					children: "Propostas por Bairro"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardDescription, {
					"data-uid": "src/components/DashboardChart.tsx:88:11",
					"data-prohibitions": "[]",
					children: "Volume de processos de locação iniciados"
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
				"data-uid": "src/components/DashboardChart.tsx:90:9",
				"data-prohibitions": "[]",
				className: "flex-1 min-h-[180px] p-4 flex items-center justify-center",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartContainer, {
					"data-uid": "src/components/DashboardChart.tsx:91:11",
					"data-prohibitions": "[]",
					config: {},
					className: "h-[180px] w-full",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BarChart, {
						"data-uid": "src/components/DashboardChart.tsx:92:13",
						"data-prohibitions": "[]",
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CartesianGrid, {
								"data-uid": "src/components/DashboardChart.tsx:97:15",
								"data-prohibitions": "[editContent]",
								strokeDasharray: "3 3",
								horizontal: false,
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(XAxis, {
								"data-uid": "src/components/DashboardChart.tsx:98:15",
								"data-prohibitions": "[editContent]",
								type: "number",
								hide: true
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(YAxis, {
								"data-uid": "src/components/DashboardChart.tsx:99:15",
								"data-prohibitions": "[editContent]",
								dataKey: "name",
								type: "category",
								axisLine: false,
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartTooltip, {
								"data-uid": "src/components/DashboardChart.tsx:107:15",
								"data-prohibitions": "[editContent]",
								cursor: { fill: "hsl(var(--muted))" },
								content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartTooltipContent, {
									"data-uid": "src/components/DashboardChart.tsx:109:26",
									"data-prohibitions": "[editContent]"
								})
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bar, {
								"data-uid": "src/components/DashboardChart.tsx:111:15",
								"data-prohibitions": "[editContent]",
								dataKey: "value",
...
//# sourceMappingURL=Index-CTpOvwDe.js.map