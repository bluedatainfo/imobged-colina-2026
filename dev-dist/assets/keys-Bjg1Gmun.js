const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/m365-e41QDDv6.js","assets/react-CaAsmmmw.js","assets/client-CX_7U15l.js","assets/use-toast-DzvQdsOw.js","assets/m365-CEkR4MVu.js","assets/main-D9Du5SIX.js","assets/preload-helper-t9NyTnoX.js"])))=>i.map(i=>d[i]);
...
var contractsStore = {
	...
	updateStatus: (id, status) => {
		...
		if (status === "Ativo") {
			...
			__vitePreload(async () => {
				const { m365Service } = await import("./m365-e41QDDv6.js");
				return { m365Service };
...
//# sourceMappingURL=keys-Bjg1Gmun.js.map