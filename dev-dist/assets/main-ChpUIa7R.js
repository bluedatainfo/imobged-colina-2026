const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/m365-D1HEl067.js","assets/react-CaAsmmmw.js","assets/client-CX_7U15l.js","assets/use-toast-DzvQdsOw.js"])))=>i.map(i=>d[i]);
...
var mainStore = {
	...
	addProperty: (p) => {
		const newProperty = {
			...p,
			id: `IMV${Math.floor(Math.random() * 1e6).toString().padStart(6, "0")}`,
...
//# sourceMappingURL=main-ChpUIa7R.js.map