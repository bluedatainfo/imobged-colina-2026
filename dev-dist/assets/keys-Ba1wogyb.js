const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/m365-BPOW6V6Y.js","assets/react-CaAsmmmw.js","assets/client-C4nUQiBY.js","assets/tslib.es6-aWCavSYD.js","assets/use-toast-DzvQdsOw.js","assets/m365-Ce2vU30i.js","assets/main-D1xDW4Mt.js","assets/preload-helper-t9NyTnoX.js"])))=>i.map(i=>d[i]);
...
var contractsStore = {
	...
	updateStatus: (id, status) => {
		...
		if (status === "Ativo") {
			...
			__vitePreload(async () => {
				const { m365Service } = await import("./m365-BPOW6V6Y.js");
				return { m365Service };
...
//# sourceMappingURL=keys-Ba1wogyb.js.map