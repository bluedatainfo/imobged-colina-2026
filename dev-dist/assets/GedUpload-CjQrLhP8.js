...
import { i as useMainStore, r as mainStore } from "./main-q-0oPKZw.js";
import { n as useEntitiesStore } from "./entities-pTkigeh5.js";
import { X as LoaderCircle, _ as documentsStore, g as useAuth, j as Input, rt as FileText } from "./index-ByKSxFGw.js";
...
var DOCUMENT_TYPES = [
	...
	{
		id: "TENANT_DOCUMENT",
		label: "Documento Locatário/Interessado"
	},
	{
...
function GedUpload({ preselectedPropertyId, preselectedType, onSuccess, mode = "file", template }) {
	...
	(0, import_react.useEffect)(() => {
		supabase.from("pre_registrations").select("id, code, full_name, category").then(({ data }) => setDbCandidates(data || []));
	}, []);
	...
	const [customFileName, setCustomFileName] = (0, import_react.useState)(mode === "scanner" ? `Scan${Math.floor(Math.random() * 1e3)}` : "");
	(0, import_react.useEffect)(() => {
		if (mode === "template" && template?.name) {
			const nameParts = template.name.split(".");
			setCustomFileName(nameParts.length > 1 ? nameParts.slice(0, -1).join(".") : template.name);
		}
	}, [mode, template]);
		...
		try {
			...
			if (mode === "scanner") {
				...
				try {
					...
					finalFileName = `${customFileName.trim().substring(0, 10) || "Scan"}.pdf`;
					finalFile = new File([blob], finalFileName, { type: "application/pdf" });
				...
				try {
					const blob = await m365Service.downloadItemContent(template.siteId, template.driveId, template.id);
					const ext = template.name.includes(".") ? template.name.substring(template.name.lastIndexOf(".")) : "";
			...
			const result = await m365Service.uploadStructuredDocument(finalFile, finalFileName, docType, propId, propTitle, user?.name || "Sistema", finalEntityCode, finalEntityName, leaseNumber, folderNumber);
			...
			const path = typeof result === "string" ? result : result?.path || result?.serverRelativeUrl || result?.webUrl || result?.url || `sharepoint:/${docType}/${finalFileName}`;
			...
			toast({
				...
				description: mode === "scanner" ? "Documento digitalizado e salvo no SharePoint com sucesso." : mode === "template" ? "Documento gerado e salvo com sucesso. Abrindo para edição..." : "Documento enviado e classificado com sucesso no SharePoint."
			});
			if (mode === "template" && typeof result !== "string" && result.webUrl) window.open(result.webUrl, "_blank");
			setFile(null);
			setEntityCode("");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		"data-uid": "src/components/GedUpload.tsx:495:5",
		"data-prohibitions": "[editContent]",
		...
		children: [
			!hasSpAccess && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Alert, {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, {
						"data-uid": "src/components/GedUpload.tsx:498:11",
						"data-prohibitions": "[editContent]",
						className: "h-4 w-4"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertTitle, {
						"data-uid": "src/components/GedUpload.tsx:499:11",
						"data-prohibitions": "[]",
						children: "Acesso Negado"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDescription, {
						"data-uid": "src/components/GedUpload.tsx:500:11",
						"data-prohibitions": "[editContent]",
						children: [
							"Seu perfil (",
							user?.role,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/GedUpload.tsx:506:7",
				"data-prohibitions": "[editContent]",
				className: "grid gap-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
					"data-uid": "src/components/GedUpload.tsx:507:9",
					"data-prohibitions": "[]",
					children: "Imóvel Relacionado"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Popover, {
					"data-uid": "src/components/GedUpload.tsx:508:9",
					"data-prohibitions": "[editContent]",
					open: propertyOpen,
					onOpenChange: setPropertyOpen,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverTrigger, {
						"data-uid": "src/components/GedUpload.tsx:509:11",
						"data-prohibitions": "[editContent]",
						asChild: true,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							"data-uid": "src/components/GedUpload.tsx:510:13",
							"data-prohibitions": "[editContent]",
							variant: "outline",
							role: "combobox",
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Command, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommandInput, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommandEmpty, {
									...
									"data-uid": "src/components/GedUpload.tsx:548:17",
									"data-prohibitions": "[editContent]",
									children: localServerProperties.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CommandItem, {
										"data-uid": "src/components/GedUpload.tsx:550:21",
										"data-prohibitions": "[editContent]",
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											"data-uid": "src/components/GedUpload.tsx:560:23",
											"data-prohibitions": "[editContent]",
											className: "flex items-center gap-2 w-full",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, {
												"data-uid": "src/components/GedUpload.tsx:561:25",
												"data-prohibitions": "[editContent]",
												className: cn("h-4 w-4 shrink-0", propertyId === (p.code || p.id) ? "opacity-100" : "opacity-0")
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												"data-uid": "src/components/GedUpload.tsx:567:25",
												"data-prohibitions": "[editContent]",
												className: "font-medium text-sm truncate text-foreground",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
													"data-uid": "src/components/GedUpload.tsx:568:27",
													"data-prohibitions": "[editContent]",
													children: [
														p.code || p.id,
														" - ",
											...
											"data-uid": "src/components/GedUpload.tsx:573:23",
											"data-prohibitions": "[editContent]",
											className: "flex items-center text-xs text-muted-foreground gap-1.5 w-full pl-6",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, {
												"data-uid": "src/components/GedUpload.tsx:574:25",
												"data-prohibitions": "[editContent]",
												className: "w-3.5 h-3.5 shrink-0 opacity-70"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												"data-uid": "src/components/GedUpload.tsx:575:25",
												"data-prohibitions": "[editContent]",
												className: "truncate",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/GedUpload.tsx:586:7",
				"data-prohibitions": "[editContent]",
				className: "grid gap-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
					"data-uid": "src/components/GedUpload.tsx:587:9",
					"data-prohibitions": "[]",
					children: "Categoria do Documento"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
					"data-uid": "src/components/GedUpload.tsx:588:9",
					"data-prohibitions": "[editContent]",
					value: docType,
					onValueChange: setDocType,
					disabled: !!preselectedType || !hasSpAccess,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
						"data-uid": "src/components/GedUpload.tsx:593:11",
						"data-prohibitions": "[]",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {
							"data-uid": "src/components/GedUpload.tsx:594:13",
							"data-prohibitions": "[editContent]",
							placeholder: "Selecione a categoria..."
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent, {
						"data-uid": "src/components/GedUpload.tsx:596:11",
						"data-prohibitions": "[editContent]",
						children: DOCUMENT_TYPES.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
							"data-uid": "src/components/GedUpload.tsx:598:15",
							"data-prohibitions": "[editContent]",
							value: t.id,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								"data-uid": "src/components/GedUpload.tsx:599:17",
								"data-prohibitions": "[editContent]",
								children: t.label
							})
						}, t.id))
			...
			docType === "OWNER_DOCUMENT" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/GedUpload.tsx:607:9",
				"data-prohibitions": "[editContent]",
				className: "grid gap-2 animate-fade-in",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
					"data-uid": "src/components/GedUpload.tsx:608:11",
					"data-prohibitions": "[]",
					children: "Proprietário (Servidor Local)"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Popover, {
					"data-uid": "src/components/GedUpload.tsx:609:11",
					"data-prohibitions": "[editContent]",
					open: ownerOpen,
					onOpenChange: setOwnerOpen,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverTrigger, {
						"data-uid": "src/components/GedUpload.tsx:610:13",
						"data-prohibitions": "[editContent]",
						asChild: true,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							"data-uid": "src/components/GedUpload.tsx:611:15",
							"data-prohibitions": "[editContent]",
							variant: "outline",
							role: "combobox",
							...
							children: [selectedOwner ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								"data-uid": "src/components/GedUpload.tsx:619:19",
								"data-prohibitions": "[editContent]",
								className: "truncate",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
									"data-uid": "src/components/GedUpload.tsx:620:21",
									"data-prohibitions": "[editContent]",
									className: "mr-1",
									children: selectedOwner.code || selectedOwner.id
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									"data-uid": "src/components/GedUpload.tsx:621:21",
									"data-prohibitions": "[editContent]",
									children: [
										" ",
										"- ",
								...
								"data-uid": "src/components/GedUpload.tsx:627:19",
								"data-prohibitions": "[]",
								className: "text-muted-foreground",
								children: "Buscar proprietário no servidor..."
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronsUpDown, {
								"data-uid": "src/components/GedUpload.tsx:629:17",
								"data-prohibitions": "[editContent]",
								className: "ml-2 h-4 w-4 shrink-0 opacity-50"
							})]
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverContent, {
						"data-uid": "src/components/GedUpload.tsx:632:13",
						"data-prohibitions": "[editContent]",
						className: "w-[--radix-popover-trigger-width] p-0",
						align: "start",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Command, {
							"data-uid": "src/components/GedUpload.tsx:633:15",
							"data-prohibitions": "[editContent]",
							shouldFilter: false,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommandInput, {
								"data-uid": "src/components/GedUpload.tsx:634:17",
								"data-prohibitions": "[editContent]",
								placeholder: "Buscar proprietário...",
								value: ownerSearchQuery,
								onValueChange: setOwnerSearchQuery
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CommandList, {
								"data-uid": "src/components/GedUpload.tsx:639:17",
								"data-prohibitions": "[editContent]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommandEmpty, {
									...
									"data-uid": "src/components/GedUpload.tsx:641:19",
									"data-prohibitions": "[editContent]",
									children: localServerOwners.map((o) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CommandItem, {
										"data-uid": "src/components/GedUpload.tsx:643:23",
										"data-prohibitions": "[editContent]",
										value: o.id || o.code,
										onSelect: () => {
											setSelectedOwner(o);
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, {
											"data-uid": "src/components/GedUpload.tsx:652:25",
											"data-prohibitions": "[editContent]",
											className: cn("mr-2 h-4 w-4", selectedOwner?.id === o.id || selectedOwner?.code === o.code ? "opacity-100" : "opacity-0")
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											"data-uid": "src/components/GedUpload.tsx:660:25",
											"data-prohibitions": "[editContent]",
											className: "truncate",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
												"data-uid": "src/components/GedUpload.tsx:661:27",
												"data-prohibitions": "[editContent]",
												className: "mr-1",
												children: o.code || o.id
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
												"data-uid": "src/components/GedUpload.tsx:662:27",
												"data-prohibitions": "[editContent]",
			...
			docType === "TENANT_DOCUMENT" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/GedUpload.tsx:675:9",
				"data-prohibitions": "[editContent]",
				className: "grid gap-2 animate-fade-in",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
					"data-uid": "src/components/GedUpload.tsx:676:11",
					"data-prohibitions": "[]",
					children: "Locatário / Interessado"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Popover, {
					"data-uid": "src/components/GedUpload.tsx:677:11",
					"data-prohibitions": "[editContent]",
					open: tenantOpen,
					onOpenChange: setTenantOpen,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverTrigger, {
						"data-uid": "src/components/GedUpload.tsx:678:13",
						"data-prohibitions": "[editContent]",
						asChild: true,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							"data-uid": "src/components/GedUpload.tsx:679:15",
							"data-prohibitions": "[editContent]",
							variant: "outline",
							role: "combobox",
							...
							children: [selectedTenant ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								"data-uid": "src/components/GedUpload.tsx:687:19",
								"data-prohibitions": "[editContent]",
								className: "truncate",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
									"data-uid": "src/components/GedUpload.tsx:688:21",
									"data-prohibitions": "[editContent]",
									className: "mr-1",
									children: selectedTenant.code || selectedTenant.id
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									"data-uid": "src/components/GedUpload.tsx:689:21",
									"data-prohibitions": "[editContent]",
									children: [
										" ",
										"- ",
								...
								"data-uid": "src/components/GedUpload.tsx:695:19",
								"data-prohibitions": "[]",
								className: "text-muted-foreground",
								children: "Buscar locatário no servidor..."
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronsUpDown, {
								"data-uid": "src/components/GedUpload.tsx:697:17",
								"data-prohibitions": "[editContent]",
								className: "ml-2 h-4 w-4 shrink-0 opacity-50"
							})]
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverContent, {
						"data-uid": "src/components/GedUpload.tsx:700:13",
						"data-prohibitions": "[editContent]",
						className: "w-[--radix-popover-trigger-width] p-0",
						align: "start",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Command, {
							"data-uid": "src/components/GedUpload.tsx:701:15",
							"data-prohibitions": "[editContent]",
							shouldFilter: false,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommandInput, {
								"data-uid": "src/components/GedUpload.tsx:702:17",
								"data-prohibitions": "[editContent]",
								placeholder: "Buscar locatário ou interessado...",
								value: tenantSearchQuery,
								onValueChange: setTenantSearchQuery
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CommandList, {
								"data-uid": "src/components/GedUpload.tsx:707:17",
								"data-prohibitions": "[editContent]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommandEmpty, {
									...
									"data-uid": "src/components/GedUpload.tsx:709:19",
									"data-prohibitions": "[editContent]",
									children: localServerTenants.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CommandItem, {
										"data-uid": "src/components/GedUpload.tsx:711:23",
										"data-prohibitions": "[editContent]",
										value: t.id || t.code,
										onSelect: () => {
											setSelectedTenant(t);
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, {
											"data-uid": "src/components/GedUpload.tsx:720:25",
											"data-prohibitions": "[editContent]",
											className: cn("mr-2 h-4 w-4", selectedTenant?.id === t.id || selectedTenant?.code === t.code ? "opacity-100" : "opacity-0")
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											"data-uid": "src/components/GedUpload.tsx:728:25",
											"data-prohibitions": "[editContent]",
											className: "truncate",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
												"data-uid": "src/components/GedUpload.tsx:729:27",
												"data-prohibitions": "[editContent]",
												className: "mr-1",
												children: t.code || t.id
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
												"data-uid": "src/components/GedUpload.tsx:730:27",
												"data-prohibitions": "[editContent]",
			...
			docType === "GUARANTEE_DOCUMENT" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/GedUpload.tsx:743:9",
				"data-prohibitions": "[editContent]",
				className: "grid gap-2 animate-fade-in",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
					"data-uid": "src/components/GedUpload.tsx:744:11",
					"data-prohibitions": "[]",
					children: "Fiador (Garantia)"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Popover, {
					"data-uid": "src/components/GedUpload.tsx:745:11",
					"data-prohibitions": "[editContent]",
					open: guarantorOpen,
					onOpenChange: setGuarantorOpen,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverTrigger, {
						"data-uid": "src/components/GedUpload.tsx:746:13",
						"data-prohibitions": "[editContent]",
						asChild: true,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							"data-uid": "src/components/GedUpload.tsx:747:15",
							"data-prohibitions": "[editContent]",
							variant: "outline",
							role: "combobox",
							...
							children: [selectedGuarantor ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								"data-uid": "src/components/GedUpload.tsx:755:19",
								"data-prohibitions": "[editContent]",
								className: "truncate",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
									"data-uid": "src/components/GedUpload.tsx:756:21",
									"data-prohibitions": "[editContent]",
									className: "mr-1",
									children: selectedGuarantor.code || selectedGuarantor.id
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									"data-uid": "src/components/GedUpload.tsx:759:21",
									"data-prohibitions": "[editContent]",
									children: [" - ", selectedGuarantor.fullName]
								})]
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								"data-uid": "src/components/GedUpload.tsx:762:19",
								"data-prohibitions": "[]",
								className: "text-muted-foreground",
								children: "Buscar fiador no SharePoint..."
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronsUpDown, {
								"data-uid": "src/components/GedUpload.tsx:764:17",
								"data-prohibitions": "[editContent]",
								className: "ml-2 h-4 w-4 shrink-0 opacity-50"
							})]
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverContent, {
						"data-uid": "src/components/GedUpload.tsx:767:13",
						"data-prohibitions": "[editContent]",
						className: "w-[--radix-popover-trigger-width] p-0",
						align: "start",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Command, {
							"data-uid": "src/components/GedUpload.tsx:768:15",
							"data-prohibitions": "[editContent]",
							shouldFilter: false,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommandInput, {
								"data-uid": "src/components/GedUpload.tsx:769:17",
								"data-prohibitions": "[editContent]",
								placeholder: "Buscar fiador...",
								value: guarantorSearchQuery,
								onValueChange: setGuarantorSearchQuery
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CommandList, {
								"data-uid": "src/components/GedUpload.tsx:774:17",
								"data-prohibitions": "[editContent]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommandEmpty, {
									"data-uid": "src/components/GedUpload.tsx:775:19",
									"data-prohibitions": "[]",
									children: "Nenhum fiador encontrado."
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommandGroup, {
									"data-uid": "src/components/GedUpload.tsx:776:19",
									"data-prohibitions": "[editContent]",
									children: localServerGuarantors.map((g) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CommandItem, {
										"data-uid": "src/components/GedUpload.tsx:778:23",
										"data-prohibitions": "[editContent]",
										value: g.id,
										onSelect: () => {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, {
											"data-uid": "src/components/GedUpload.tsx:787:25",
											"data-prohibitions": "[editContent]",
											className: cn("mr-2 h-4 w-4", selectedGuarantor?.id === g.id ? "opacity-100" : "opacity-0")
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											"data-uid": "src/components/GedUpload.tsx:793:25",
											"data-prohibitions": "[editContent]",
											className: "truncate",
											children: g.fullName
										})]
			...
			[
				...
				"data-uid": "src/components/GedUpload.tsx:805:9",
				"data-prohibitions": "[]",
				className: "grid gap-2 animate-fade-in",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
					"data-uid": "src/components/GedUpload.tsx:806:11",
					"data-prohibitions": "[]",
					children: "Número da Locação"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
					"data-uid": "src/components/GedUpload.tsx:807:11",
					"data-prohibitions": "[editContent]",
					value: leaseNumber,
			...
			["CONTRACT_ACTIVE", "CONTRACT_TERMINATED"].includes(docType) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/GedUpload.tsx:817:9",
				"data-prohibitions": "[]",
				className: "grid gap-2 animate-fade-in",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
					"data-uid": "src/components/GedUpload.tsx:818:11",
					"data-prohibitions": "[]",
					children: "Número da Pasta"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
					"data-uid": "src/components/GedUpload.tsx:819:11",
					"data-prohibitions": "[editContent]",
					value: folderNumber,
			...
			mode === "file" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/GedUpload.tsx:829:9",
				"data-prohibitions": "[]",
				className: "grid gap-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
					"data-uid": "src/components/GedUpload.tsx:830:11",
					"data-prohibitions": "[]",
					children: "Arquivo Selecionado"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
					"data-uid": "src/components/GedUpload.tsx:831:11",
					"data-prohibitions": "[editContent]",
					id: "file-upload",
					type: "file",
			...
			mode === "template" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/GedUpload.tsx:836:9",
				"data-prohibitions": "[editContent]",
				className: "grid gap-2 animate-fade-in",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
					"data-uid": "src/components/GedUpload.tsx:837:11",
					"data-prohibitions": "[]",
					children: "Nome do Novo Arquivo"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					"data-uid": "src/components/GedUpload.tsx:838:11",
					"data-prohibitions": "[editContent]",
					className: "flex items-center gap-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
						"data-uid": "src/components/GedUpload.tsx:839:13",
						"data-prohibitions": "[editContent]",
						...
						"data-uid": "src/components/GedUpload.tsx:845:13",
						"data-prohibitions": "[editContent]",
						className: "text-sm text-muted-foreground font-medium whitespace-nowrap",
						children: template?.name?.includes(".") ? template.name.substring(template.name.lastIndexOf(".")) : ""
					})]
				})]
			}),
			mode === "scanner" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-uid": "src/components/GedUpload.tsx:855:9",
				"data-prohibitions": "[]",
				className: "space-y-4 p-4 border rounded-lg bg-muted/20 animate-fade-in",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/GedUpload.tsx:856:11",
						"data-prohibitions": "[]",
						className: "flex items-center justify-between mb-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-uid": "src/components/GedUpload.tsx:857:13",
							"data-prohibitions": "[]",
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Printer, {
								"data-uid": "src/components/GedUpload.tsx:858:15",
								"data-prohibitions": "[editContent]",
								className: "h-4 w-4 text-primary"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								"data-uid": "src/components/GedUpload.tsx:859:15",
								"data-prohibitions": "[]",
								className: "font-medium text-sm",
								children: "Configurações de Captura"
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							"data-uid": "src/components/GedUpload.tsx:861:13",
							"data-prohibitions": "[]",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/GedUpload.tsx:865:11",
						"data-prohibitions": "[]",
						className: "space-y-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
							"data-uid": "src/components/GedUpload.tsx:866:13",
							"data-prohibitions": "[]",
							className: "text-xs",
							children: "Nome do Arquivo (Máx 10 caracteres)"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-uid": "src/components/GedUpload.tsx:867:13",
							"data-prohibitions": "[]",
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
								"data-uid": "src/components/GedUpload.tsx:868:15",
								"data-prohibitions": "[editContent]",
								value: customFileName,
								onChange: (e) => setCustomFileName(e.target.value),
								maxLength: 10,
								...
								"data-uid": "src/components/GedUpload.tsx:876:15",
								"data-prohibitions": "[]",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/GedUpload.tsx:879:11",
						"data-prohibitions": "[]",
						className: "grid grid-cols-2 gap-4",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-uid": "src/components/GedUpload.tsx:880:13",
							"data-prohibitions": "[]",
							className: "space-y-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
								"data-uid": "src/components/GedUpload.tsx:881:15",
								"data-prohibitions": "[]",
								className: "text-xs",
								children: "Resolução (DPI)"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
								"data-uid": "src/components/GedUpload.tsx:882:15",
								"data-prohibitions": "[]",
								value: dpi,
								onValueChange: setDpi,
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
									"data-uid": "src/components/GedUpload.tsx:883:17",
									"data-prohibitions": "[]",
									className: "h-8 text-xs",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {
										"data-uid": "src/components/GedUpload.tsx:884:19",
										"data-prohibitions": "[editContent]",
										placeholder: "Selecione DPI"
									})
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, {
									"data-uid": "src/components/GedUpload.tsx:886:17",
									"data-prohibitions": "[]",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
											"data-uid": "src/components/GedUpload.tsx:887:19",
											"data-prohibitions": "[]",
											value: "200",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												"data-uid": "src/components/GedUpload.tsx:888:21",
												"data-prohibitions": "[]",
												children: "200 DPI"
											})
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
											"data-uid": "src/components/GedUpload.tsx:890:19",
											"data-prohibitions": "[]",
											value: "300",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												"data-uid": "src/components/GedUpload.tsx:891:21",
												"data-prohibitions": "[]",
												children: "300 DPI"
											})
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
											"data-uid": "src/components/GedUpload.tsx:893:19",
											"data-prohibitions": "[]",
											value: "600",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												"data-uid": "src/components/GedUpload.tsx:894:21",
												"data-prohibitions": "[]",
												children: "600 DPI"
											})
										})
							...
							className: "space-y-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
								"data-uid": "src/components/GedUpload.tsx:900:15",
								"data-prohibitions": "[]",
								className: "text-xs",
								children: "Cor"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
								"data-uid": "src/components/GedUpload.tsx:901:15",
								"data-prohibitions": "[]",
								value: colorMode,
								onValueChange: setColorMode,
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
									"data-uid": "src/components/GedUpload.tsx:902:17",
									"data-prohibitions": "[]",
									className: "h-8 text-xs",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {
										"data-uid": "src/components/GedUpload.tsx:903:19",
										"data-prohibitions": "[editContent]",
										placeholder: "Selecione Cor"
									})
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, {
									"data-uid": "src/components/GedUpload.tsx:905:17",
									"data-prohibitions": "[]",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
											"data-uid": "src/components/GedUpload.tsx:906:19",
											"data-prohibitions": "[]",
											value: "color",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												"data-uid": "src/components/GedUpload.tsx:907:21",
												"data-prohibitions": "[]",
												children: "Cores"
											})
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
											"data-uid": "src/components/GedUpload.tsx:909:19",
											"data-prohibitions": "[]",
											value: "gray",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												"data-uid": "src/components/GedUpload.tsx:910:21",
												"data-prohibitions": "[]",
												children: "Tons de Cinza"
											})
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
											"data-uid": "src/components/GedUpload.tsx:912:19",
											"data-prohibitions": "[]",
											value: "bw",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												"data-uid": "src/components/GedUpload.tsx:913:21",
												"data-prohibitions": "[]",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						"data-uid": "src/components/GedUpload.tsx:919:11",
						"data-prohibitions": "[]",
						className: "flex items-center justify-between",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
							"data-uid": "src/components/GedUpload.tsx:920:13",
							"data-prohibitions": "[]",
							className: "text-xs",
							children: "Frente e Verso (Duplex)"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Switch, {
							"data-uid": "src/components/GedUpload.tsx:921:13",
							"data-prohibitions": "[editContent]",
							checked: duplex,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
				"data-uid": "src/components/GedUpload.tsx:943:7",
				"data-prohibitions": "[editContent]",
				className: "w-full mt-auto gap-2",
				onClick: handleUpload,
				disabled: mode === "file" && !file || mode === "template" && (!template || !customFileName.trim()) || mode === "scanner" && !customFileName.trim() || !propertyId || !docType || uploading || !hasSpAccess || docType === "OWNER_DOCUMENT" && !selectedOwner || docType === "TENANT_DOCUMENT" && !selectedTenant || docType === "GUARANTEE_DOCUMENT" && !selectedGuarantor || [
					"INSPECTION_MOVE_IN",
					"INSPECTION_MOVE_OUT",
					"LEASES"
				...
				children: uploading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, {
					"data-uid": "src/components/GedUpload.tsx:964:13",
					"data-prohibitions": "[editContent]",
					className: "h-4 w-4 animate-spin shrink-0"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					"data-uid": "src/components/GedUpload.tsx:965:13",
					"data-prohibitions": "[editContent]",
					className: "truncate",
					...
					"data-uid": "src/components/GedUpload.tsx:969:13",
					"data-prohibitions": "[editContent]",
					className: "h-4 w-4 shrink-0"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					"data-uid": "src/components/GedUpload.tsx:970:13",
					"data-prohibitions": "[]",
					className: "truncate",
					children: "Digitalizar e Enviar (GED)"
				})] }) : mode === "template" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, {
					"data-uid": "src/components/GedUpload.tsx:974:13",
					"data-prohibitions": "[editContent]",
					className: "h-4 w-4 shrink-0"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					"data-uid": "src/components/GedUpload.tsx:975:13",
					"data-prohibitions": "[]",
					className: "truncate",
					children: "Gerar Documento e Editar"
				})] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CloudUpload, {
					"data-uid": "src/components/GedUpload.tsx:979:13",
					"data-prohibitions": "[editContent]",
					className: "h-4 w-4 shrink-0"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					"data-uid": "src/components/GedUpload.tsx:980:13",
					"data-prohibitions": "[]",
					className: "truncate",
...
//# sourceMappingURL=GedUpload-CjQrLhP8.js.map