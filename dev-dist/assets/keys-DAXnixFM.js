const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/m365-Dd2RTYoz.js","assets/react-CaAsmmmw.js","assets/client-BWrqzmk9.js","assets/tslib.es6-9TrgXIU4.js","assets/use-toast-DzvQdsOw.js","assets/m365-BW416V_E.js","assets/main-buh-Al_F.js","assets/preload-helper-t9NyTnoX.js"])))=>i.map(i=>d[i]);
...
var contractsStore = {
	...
	updateStatus: (id, status) => {
		...
		if (status === "Ativo") {
			...
			__vitePreload(async () => {
				const { m365Service } = await import("./m365-Dd2RTYoz.js");
				return { m365Service };
...
//# sourceMappingURL=keys-DAXnixFM.js.map